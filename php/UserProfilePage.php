        ...
        <?php
            ...
            ?>
                ...
                <table>
                    <tr>
                        <td>
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['Image']); ?>" style="width: 240px; height: 250px; " />
                        </td>
                        <td>
                            <div>
                                <fieldset>
                                    ...
                                    <h3>Contact:       <?php echo $row["Contacts"]; ?> </h3>
                ...
                <a href="edituser.php"><button type="button" class="btn">Edit</button></a>
</div>
