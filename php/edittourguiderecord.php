...
<body>
	...
	<form method="post" action = "submitedittourguiderecord.php?id=<?php echo $id; ?>" class="frm">
		Guide Name:</br>
		<input type="text" name="name" value="<?php echo $name; ?>" required><br/><br/>
		Contact:</br>
		<input type="text" name="contact" value="<?php echo $contact; ?>" required><br/><br/>
		Guide NIC:</br>
		<input type="text" name="guidenic" value="<?php echo $nic; ?>" style="width: 500px; height: 50px;" required><br/><br/>
		Price Per Day:</br>
		<input type="text" name="price" value="<?php echo $ppd; ?>" required><br/><br/>
