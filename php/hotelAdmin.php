...
<body>
	...
	<center><h1>Hotel List</h1></center><br>
	<table style="width:100%;">
	  <tr>
	  	<th></th>
	    <th style="float: left;">Hotel ID</th>
	    <th style="column-width: 80px;">Hotel Name</th>
	    <th style="float: center;">Hotel Address</th>
	...
	<?php
	  		...
	  		if($result->num_rows > 0)
	  		{
	  			while($row = $result->fetch_assoc())
	  			{
	  				$id = $row["Hotel_Id"];
					echo  	"<tr>";
					echo	"<td></td><td>" .$row["Hotel_Id"]. "</td>";
					echo	"<td>" .$row["Hotel_name"]. "</td>";
					echo	"<td>" .$row["Hotel_Address"]. "</td>";
					echo	"<td>" .$row["Contacts"]. "</td>";
					echo	"<td><button type='submit'><a href='edithotelrecord.php?id=$id'>Edit</a></button></td>";
	...
	<br><br>
	<center><a href="newhotelAdmin.php" style="text-decoration: none;"> <button type="button" class="button1">Add new Hotel</button></a></center>
