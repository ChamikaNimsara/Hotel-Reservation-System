...
<body>
    ...
    <ul class="breadcrumb" style="margin: 0; ">
            ...
            <li><a href="loginhotelpage.php">Hotel Selection</a></li>
...
<br>
        ...
        <form action = "bookhotel.php" class="frm" method="post" enctype="multipart/form-data">
            Hotel Name:
            <input type="text" name="name" value="<?php echo $row["Hotel_name"]; ?>" required><br/><br/>
            Check In date:
            <input type="date" name="indate" required><br/><br/>
            Check Out Date:
            <input type="date" name="outdate" required><br/><br/>
            Number of Rooms:
            <input type="text" name="num" required><br/><br/>
            Price Per Room:
            <input type="text" name="price" value="<?php echo $row["Price_Per_Room"]; ?>" required><br/><br/>
