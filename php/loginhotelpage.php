...
<body>
    ...
    <form action='loginhotel.php?id='id>
        <label for="hotels">Choose a hotel:</label>
        <select name="hotels" id="hid">
            <?php
            ...
            if($result->num_rows > 0)
            {
                ...
                {
                    $id = $row["Hotel_Id"];
                    echo    "<option value='$id'>" .$row["Hotel_name"]. "</option>";
                }
            }
...
<table style="width:100%;">
      <tr>
        ...
        <th style="column-width: 80px;">Price per room</th>
     </tr>
    ...
    <?php
            ...
            if($result->num_rows > 0)
            {
                while($row = $result->fetch_assoc())
                {
                    ...
                    echo    "<td>$" .$row["Price_Per_Room"]. ".00</td>";
                    echo    "</tr>";
                }
            }
            else echo "<script>alert('No items selected')</script>";
