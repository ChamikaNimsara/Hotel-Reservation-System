...
<body>
	...
	<ul class="breadcrumb" style="margin: 0; ">
  			...
  			<li><a href="..\src\hotelAdmin.php">Hotel List</a></li>
  			<li>Add new hotel</li>
		</ul>
	<hr style="margin: 0; border: 2px solid black; background-color: black;">
	<br>

	<form method="post" action = "submitnewhotel.php" class="frm">
		Hotel Name:</br>
		<input type="text" name="name" placeholder="Hotel Name" required><br/><br/>
		Address:</br>
		<input type="text" name="address" placeholder="Hotel Address" style="width: 500px; height: 50px;" required><br/><br/>
		Contact:</br>
		<input type="text" name="contact" placeholder="Contact number" required><br/><br/>
		<center><input type="submit" value="Add Hotel" class="button1"></center>
	</form>
