...
<body>
	...
	<ul class="breadcrumb" style="margin: 0; ">
  			<li><a href="..\src\adminHome.php">Admin Home</a></li>
  			<li><a href="..\src\tableAdmin.php">Table List</a></li>
  			<li>Add new table</li>
		</ul>
	<hr style="margin: 0; border: 2px solid black; background-color: black;">
	<br>

	<form method="post" action = "submitnewtable.php" class="frm">
		Hotel ID:</br>
		<input type="text" name="hid" placeholder="Hotel ID" required><br/><br/>
		Table Number:</br>
		<input type="text" name="tableno" placeholder="Table Number" required><br/><br/>
		Table Price per person:</br>
		<input type="text" name="tableprice" placeholder="Table Price" required><br/><br/>
		<center><input type="submit" value="Add Table" class="button1"></center>
	</form>
