...
<body>
	...
	<ul class="breadcrumb" style="margin: 0; ">
  			...
  			<li><a href="..\src\tourguideAdmin.php">Tour Guide List</a></li>
  			<li>Add new tour guide</li>
		</ul>
	<hr style="margin: 0; border: 2px solid black; background-color: black;">
	<br>

	<form method="post" action = "submitnewtourguide.php" class="frm">
		Guide Name:</br>
		<input type="text" name="name" placeholder="Guide Name" required><br/><br/>
		Contact:</br>
		<input type="text" name="contact" placeholder="Contact number" required><br/><br/>
		Guide NIC:</br>
		<input type="text" name="guidenic" placeholder="Guide NIC" style="width: 500px; height: 50px;" required><br/><br/>
		Price Per Day:</br>
		<input type="text" name="price" placeholder="$$$$" required><br/><br/>
		<center><input type="submit" value="Add Tour Guide" class="button1"></center>
	</form>
