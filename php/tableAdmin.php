...
<script>
	function delete_data(id)
	{
		...
		{
			window.location.href = 'submitdeletetables.php?id='+id;
		}
	}
</script>
...
<body>
	...
	<center><h1>Table List</h1></center><br>
	<table style="width:100%;">
	  <tr>
	  	<th></th>
	    <th style="float: left;">Table ID</th>
	    <th style="column-width: 60px;">Hotel Name</th>
	    <th style="column-width: 90px;">Table Number</th>
	    <th style="column-width: 120px;">Price per person</th>
	 </tr>
	...
	<?php
	  		...
	  		if($result->num_rows > 0)
	  		{
	  			while($row = $result->fetch_assoc())
	  			{
	  				$id = $row["Table_Id"];
					echo  	"<tr>";
					echo	"<td></td><td>" .$row["Table_Id"]. "</td>";
					echo	"<td>" .$row["Hotel_name"]. "</td>";
					echo	"<td>" .$row["Table_No"]. "</td>";
					echo	"<td>$" .$row["Table_Price"]. ".00</td>";
					echo	"<td><button type='submit'><a href='edittablerecord.php?id=$id'>Edit</a></button></td>";
	...
	<br><br>
	<center><a href="newtableAdmin.php" style="text-decoration: none;"> <button type="button" class="button1">Add new Table</button></a></center>
